...
const PrashnaEngine: React.FC<PrashnaEngineProps> = ({ lang, mode }) => {
  ...
  return (
    <div className="w-full bg-white/80 backdrop-blur-xl rounded-[3rem] p-8 sm:p-12 border-4 border-[#D4AF37]/30 shadow-2xl relative overflow-hidden">
      ...
      <div className="absolute -bottom-24 -left-24 w-64 h-64 bg-[#451a03]/5 rounded-full blur-3xl" />
      
      <div className="relative z-10">
        <div className="flex items-center gap-4 mb-8">
          <div className="w-14 h-14 bg-gradient-to-br from-[#451a03] to-[#7c2d12] rounded-2xl flex items-center justify-center text-[#D4AF37] shadow-xl">
            <HelpCircle size={32} />
          </div>
          <div>
            <h3 className="text-2xl sm:text-3xl font-black text-[#451a03] uppercase tracking-widest astrological-font leading-none">
              {lang === 'kn' ? 'ಪ್ರಶ್ನ ಶಾಸ್ತ್ರ' : lang === 'hi' ? 'प्रश्न शास्त्र' : 'Prashna (Horary) Oracle'}
            </h3>
            <p className="text-[10px] font-black text-[#7C2D12]/60 uppercase tracking-[0.3em] mt-2">
          ...
          <div className="space-y-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="flex flex-col gap-1.5">
                <label className="text-[10px] font-bold text-[#451a03] uppercase tracking-widest ml-1">
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <div className="flex items-center gap-2 bg-amber-50/50 border-2 border-[#D4AF37]/20 rounded-2xl p-4 text-lg font-bold text-[#451a03] shadow-inner">
            ...
            <div className="relative">
              <textarea
                ...
                className="w-full bg-amber-50/50 border-2 border-[#D4AF37]/20 rounded-[2rem] p-6 sm:p-8 text-lg font-bold text-[#451a03] focus:border-[#D4AF37] outline-none min-h-[150px] shadow-inner transition-all placeholder:text-[#451a03]/30"
              />
              <div className="absolute bottom-6 right-6 flex items-center gap-3 text-[#451a03]/40">
                <Clock size={16} />
            ...
            <button
              ...
              className="w-full py-6 bg-gradient-to-r from-[#451a03] to-[#7c2d12] text-[#D4AF37] rounded-[2rem] font-black uppercase tracking-[0.4em] text-sm shadow-2xl hover:scale-[1.02] active:scale-95 transition-all disabled:opacity-50 flex items-center justify-center gap-4 group"
            >
              {isAnalyzing ? (
                <>
